...
def save_logs(output_directory, hist, y_pred, y_pred_proba, y_true, duration,
    ...
    if plot_test_acc:
        # plot losses
        plot_epochs_metric(hist, output_directory + f'epochs_loss.png')
        plot_epochs_metric(hist, output_directory + f'epochs_accuracy.png', metric='accuracy', name="Accuracy")
