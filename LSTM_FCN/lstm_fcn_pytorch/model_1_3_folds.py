...
class Model():
    ...
    def fit(self, learning_rate, batch_size, epochs, saving_directory, fold_index, verbose=True):
        ...
        patience = 50
        actual_epochs = 0 
        best_model_path = 'best_model_folds.pth' 
        ...
        if verbose:
            directory1 = saving_directory + f'/epochs_loss{fold_index}.png'
            directory2 = saving_directory + f'/epochs_accuracy{fold_index}.png'
    ...
    def evaluate(self, y_pred_labels, y_pred,  targets_test, saving_directory, fold_index, class_names):
        ...
        csv_file_path = saving_directory + f'/test_metrics_{fold_index}.csv'
