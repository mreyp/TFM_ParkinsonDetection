...
class FCN(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        x: torch.Tensor.
            ...
            time series and length is the length of the time series.
         __________________________________
        Mimicking the behavior of GlobalAveragePooling1D: 
            average over the length of the time series
...
class LSTM_FCN(torch.nn.Module):
    ...
    def __init__(self, input_length, units, dropout, dropout2, filters, kernel_sizes, num_classes):
        ...
        self.fcn = FCN(filters, kernel_sizes, dropout2)
