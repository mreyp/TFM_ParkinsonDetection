...
from time_train import plot_metrics
from time_train import evaluate
...
# Data
data_train = pd.read_csv(f'TFM_MartaRey/datos/whale_dataset/{TASK}_train.csv')
...
data_val = pd.read_csv(f'TFM_MartaRey/datos/whale_dataset/{TASK}_val.csv')
...
data_test = pd.read_csv(f'TFM_MartaRey/datos/whale_dataset/{TASK}_test.csv')
...
directory1 = SAVING + f'/epochs_loss.png'
directory2 = SAVING + f'/epochs_accuracy.png'
...
accuracy, precision, recall, f1, auc_score = evaluate(net, device, testloader, ['Control', 'Parkinson'], SAVING)
