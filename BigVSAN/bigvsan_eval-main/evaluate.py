...
def evaluate(gt_dir, synth_dir):
    ...
    with torch.no_grad():
        ...
        for wavID in iterator:
            ...
            # Encuentra todos los archivos generados correspondientes basados en el nombre del archivo real
            matching_synth_files = [f for f in synth_files if base_name in os.path.splitext(f)[0]]
    ...
    return {
        'M-STFT': mrstft_tot / len(synth_files),
        'PESQ': pesq_tot / len(synth_files),
